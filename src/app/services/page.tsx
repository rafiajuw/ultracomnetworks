...
import { Search, Filter, ArrowRight, Download, Phone, Mail } from "lucide-react";
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
              {filteredServices.map((service) => (
                <Link href={service.href} key={service.href}>
                  <div className="group bg-white rounded-3xl shadow-md hover:shadow-2xl transition-all duration-300 border border-gray-100 overflow-hidden h-full flex flex-col">
      ...
      <section className="py-24 bg-gradient-to-r from-slate-800 via-blue-900 to-slate-900 text-white">
        <div className="max-w-5xl mx-auto text-center px-6">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            ...
            >
              <Phone className="w-6 h-6" /> +92 311 1000605
            </a>
            <a

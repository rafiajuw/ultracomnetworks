...
const offices = [
  {
    ...
    phone: "+92 311 1000605",
    email: "info@ultracom.net",
  ...
  {
    city: "Lahore",
    address: "89-B, Gulberg III, Main Boulevard, Lahore, Pakistan",
    phone: "+92 311 1000605",
    email: "lahore@ultracom.net",
    hours: "Mon–Fri: 9:00 AM – 6:00 PM",
    map: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3400.689!2d74.356!3d31.520!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3919048b2f5d8b8d%3A0x8f8f8f8f8f8f8f8f!2sGulberg%20III!5e0!3m2!1sen!2s!4v1698765432100!5m2!1sen!2s",
  },
  {
    city: "Islamabad",
    address: "Plot 12, F-7 Markaz, Jinnah Super Market, Islamabad, Pakistan",
    phone: "+92 311 1000605",
    email: "islamabad@ultracom.net",
    hours: "Mon–Fri: 9:00 AM – 6:00 PM",
    map: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3320.123!2d73.056!3d33.720!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x38df948b5f5d5d5d%3A0x6f6f6f6f6f6f6f6f!2sF-7%20Markaz!5e0!3m2!1sen!2s!4v1698765432102!5m2!1sen!2s",
  },
];
        ...
        <div className="relative z-10 flex items-center justify-center h-full px-6 text-center">
          ...
          >
            ...
            <p className="text-2xl md:text-4xl font-light text-blue-200">
              Nationwide Presence Across Pakistan
            </p>
            <p className="text-lg md:text-xl text-blue-100 mt-6 max-w-3xl mx-auto">
              Visit our offices in Karachi, Lahore & Islamabad — we’re always ready to serve you.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-24 bg-gradient-to-r from-slate-800 via-blue-900 to-slate-900 text-white text-center">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <p className="text-xl text-blue-100 mb-12">
            Drop by anytime — our team is always happy to assist you.
          </p>
